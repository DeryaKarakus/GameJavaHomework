...
public class EPAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EPADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EPAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EPADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EPADateTimeConverter dateTimeConverter = new EPAStandardDateTimeConverter();

    public EPAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EPAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EPAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EPAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EPAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EPAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
