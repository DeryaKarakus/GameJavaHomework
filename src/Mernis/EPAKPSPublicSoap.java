...
public class EPAKPSPublicSoap
{
    ...
    public EPAKPSPublicSoap(){}

    public EPAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EPAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EPAExtendedSoapSerializationEnvelope envelope= new EPAExtendedSoapSerializationEnvelope(EPAExtendedSoapSerializationEnvelope.VER11);
